...
% ---- Persönlichen Daten:
\newcommand{\titel}{Benchmarking der Optimierung von Datenbankabfragen in der HANA \acl{CE}}
...
\include{Inhalt/04_Inhalt/konzept}
\include{Inhalt/04_Inhalt/umsetzung}
\include{Inhalt/04_Inhalt/verifikation}
